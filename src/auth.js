...
const btnNewInvoiceNav = document.getElementById('btn-new-invoice');
...
function updateUI(user) {
  if (user) {
    ...
    if (btnNewInvoiceNav) btnNewInvoiceNav.style.display = 'flex';
    if (userProfile) {
    ...
    if (btnNewInvoiceNav) btnNewInvoiceNav.style.display = 'none';
    if (userProfile) {
